...
(function () {
  ...
  function veNav() {
    ...
    var duoi = gom ? chinh.concat([QUAN_TRI]) : ds;
  ...
  document.addEventListener('click', function (e) {
    ...
    if ('xemThem' in d) { S.phanTrang[d.xemThem].so += MOI_TRANG; return d.xemThem === 'khach' ? veDsKhach() : veDsCoSo(); }
